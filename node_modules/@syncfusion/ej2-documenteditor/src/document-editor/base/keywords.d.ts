...
export declare const horizontalRuleProperty: string[];
...
export declare const isCreatedUsingHtmlSpanTagProperty: string[];
...
export declare const isLegalStyleNumberingProperty: string[];
...
export declare const paraStyleNameProperty: string[];
...
export declare const incrementalOps: string[];
