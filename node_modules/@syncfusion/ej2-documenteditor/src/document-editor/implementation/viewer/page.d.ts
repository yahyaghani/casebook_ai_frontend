...
export declare class TableRowWidget extends BlockWidget {
     ...
     * @private
     */
    getCell(rowIndex: number, columnIndex: number, cellIndex?: number): TableCellWidget;
    /**
     * @private
     */
 ...
 * @private
 */
export declare class FootnoteEndnoteMarkerElementBox extends TextElementBox {
    /**
     * @private
     */
    getLength(): number;
     ...
     * @private
     */
    clone(): FootnoteEndnoteMarkerElementBox;
}
