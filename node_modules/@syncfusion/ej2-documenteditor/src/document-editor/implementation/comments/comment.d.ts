...
export declare class CommentReviewPane {
    ...
    selectReviewTab(tab: ReviewTabType): void;
...
export declare class CommentView {
    ...
    menuBar: HTMLElement;
    resolveDiv: HTMLElement;
    commentEditorIcon: CommentCharacterElementBox;
    ...
    replyViewTextBox: HTMLElement;
    replyPostButton: Button;
    replyCancelButton: Button;
    replyFooter: HTMLElement;
    reopenButton: Button;
    deleteButton: Button;
    resolveView: HTMLElement;
    private itemData;
    private editMention;
    private replyMention;
