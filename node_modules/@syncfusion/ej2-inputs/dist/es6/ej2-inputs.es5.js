...
var TextArea = /** @__PURE__ @class */ (function (_super) {
     ...
     * @returns {void}
     */
    TextArea.prototype.addAttributes = function (attributes$$1) {
        for (var _i = 0, _a = Object.keys(attributes$$1); _i < _a.length; _i++) {
            var key = _a[_i];
            if (key === 'disabled') {
                this.setProperties({ enabled: false }, true);
     ...
     * @returns {void}
     */
    TextArea.prototype.removeAttributes = function (attributes$$1) {
        for (var _i = 0, attributes_1 = attributes$$1; _i < attributes_1.length; _i++) {
            var key = attributes_1[_i];
            if (key === 'disabled') {
                this.setProperties({ enabled: true }, true);
