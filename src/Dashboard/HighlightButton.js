...
function HighlightButton(props){
    ...
    async function getHighlightData() {
        await axios
        .post("http://127.0.0.1:5000/api/v1/savejsondata", {
          [pdfName]: highlightData,
        })
    ...
    return(
        <Fragment>
            ...
            <Button className="btn btn-md" outline color='light' onClick={getHighlightData}>Save Highlight JSON</Button>
