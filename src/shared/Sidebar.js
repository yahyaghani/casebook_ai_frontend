...
function Sidebar({ items, itemClicks }) {
	...
	return (
		<nav className="sidebar sidebar-offcanvas" id="sidebar">
			...
			<ul className="nav">
				<Profile profileClick={() => handleClick(showProfile)}
				...
				<SideNav class={items.showDashboardView} click={() => handleClick(showDashboard)}
					iconClass='mdi mdi-speedometer' transTitle='Dashboard' />

				<SideNav class={items.showHighlight} click={() => handleClick(showHighlight)}
				...
				<SideNav class={items.showFileViewer} click={() => handleClick(showFileViewer)}
					iconClass='mdi mdi-file' transTitle='File Viewer' />

				<SideNav class={items.showFeedView} click={() => handleClick(showFeedView)}
					iconClass='mdi mdi-forum' transTitle='My Feeds' />
			</ul>
			{showTextEditor && (
				<TextEditor id={state.auth && state.auth.userPublicId}
					fileName={'index'} showTextEditor={showTextEditor}
